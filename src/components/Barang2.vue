        ...
        <v-dialog v-model="dialog" max-width="600px">
          ...
          <v-card>
            ...
            <v-row>
                  ...
                  <v-col cols="18" sm="10" md="6">
                    <v-text-field v-model="editedItem.kdsuplier" label="Kode Suplier" :rules="rules"></v-text-field>
                  </v-col>
                  <v-col cols="18" sm="10" md="6">
  ...
  export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Kode Suplier', value: 'kdsuplier' },
    ...
    methods: {
      ...
      TambahkanBarang() {
        api.post('/barang',
          { kode: this.editedItem.kode,
            ...
            kdsuplier: this.editedItem.kdsuplier,
      ...
      updateBarang() {
        api.put('/barang/'+ this.editedItem.id,
          { 
            kode: this.editedItem.kode,
            nama: this.editedItem.nama,
            merk: this.editedItem.merk,
      ...
      save () {
        if (this.editedIndex > -1) {
          Object.assign(this.barang[this.editedIndex], this.editedItem)
           this.updateBarang(this.editedItem)
        } else {
